...
export default function ServicesHero() {
  return (
    <section className="relative min-h-[60dvh] flex items-center bg-[var(--color-deep-navy)] overflow-hidden">
      {/* Noise */}
      <div
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-6 lg:px-8 w-full pt-36 pb-24">
        ...
        >
          ...
          >
            ...
            <span className="text-xs text-[var(--color-gold-accent)]">Services</span>
          </motion.nav>
          ...
          >
            A full suite of financial services designed to give you clarity,
            reduce administrative burden, and keep your business running clean.
          </motion.p>
        </motion.div>
      </div>
